...
public sealed class WithdrawOperationRepository : BaseRepository, IOperationRepository<WithdrawOperationEntity>
{
    public async Task<WithdrawOperationEntity?> TryGet(Guid guid, CancellationToken token)
    {
        ...
        return (await ExecuteQueryAsync<WithdrawOperationEntity>(sqlQuery, param, token)).FirstOrDefault(); 
    }

    public async Task<ResultEntity<string?>> Insert(WithdrawOperationEntity operation, CancellationToken token)
    {
    ...
    public async Task<ResultEntity<string?>> Update(WithdrawOperationEntity operation, CancellationToken token)
    {
        const string sqlQuery = @"
                update withdraw_operations
